...
const PedidoSchema = new mongoose.Schema({
  ...
  // Evita descontar el inventario dos veces: Stripe puede reenviar
  // webhooks y el administrador podría repetir una confirmación.
  inventarioProcesado: { type: Boolean, default: false },
  fechaInventarioProcesado: { type: Date, default: null },
